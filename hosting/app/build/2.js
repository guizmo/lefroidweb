webpackJsonp([2],Array(393).concat([
/* 393 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(521);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home__ = __webpack_require__(525);
 ...
 * \@stable
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* Version */]('4.1.3');
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(521);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(526);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angularfire2_database__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_angularfire2_auth__ = __webpack_require__(80);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    function HomePage(http, navCtrl, navParams, afdb, loadingCtrl, afAuth) {
        var _this = this;
        this.http = http;
    ...
    HomePage.prototype.init = function () {
        ...
        this.appSettingsSub = this.appSettings.subscribe(function (res) {
            _this.settings = {
                album: res.album,
    ...
    HomePage.prototype.envModeToggle = function () {
        this.envMode = (this.settings.messagingENV == 'PROD') ? true : false;
    };
    HomePage.prototype.envModeChange = function () {
        console.log(this.envMode);
        var envMode = (this.envMode) ? 'PROD' : 'DEV';
        this.update({ messagingENV: envMode });
    };
    HomePage.prototype.update = function (obj) {
        this.appSettings.update(obj);
    };
    HomePage.prototype.updateDateFilter = function () {
        var _a = this.settings, endDate = _a.endDate, startDate = _a.startDate;
        this.appSettings.update({ startDate: startDate });
        this.appSettings.update({ endDate: endDate });
    };
    HomePage.prototype.fetchTwilioData = function (page_uri) {
        var _this = this;
        if (page_uri === void 0) { page_uri = null; }
        if (!page_uri) {
        ...
        var AccountSid = this.Twilio.api_key;
        var AuthToken = this.Twilio.api_secret;
        var requestUri = (page_uri) ? "https://api.twilio.com" + page_uri : this.Twilio.API + "?PageSize=1000";
        ...
        this.twilioRequestSub = this.twilioRequest.map(function (res) { return res.json(); })
            .subscribe(function (res) {
            _this.twilioData = res;
            var tmpArr = _this.twilioMessages.concat(res.messages);
            _this.twilioMessages = tmpArr;
            _this.sortTwilioData();
        }, function (err) {
            err = err.json();
            console.log('Twilio err', err);
        });
    };
    HomePage.prototype.sortTwilioData = function () {
        var _this = this;
        var messages = this.twilioData.messages;
        if (this.twilioData.next_page_uri) {
            this.fetchTwilioData(this.twilioData.next_page_uri);
        }
        else {
            var startDate_1 = __WEBPACK_IMPORTED_MODULE_4_moment___default()(this.settings.startDate, "YYYY-MM-DD");
            var endDate_1 = __WEBPACK_IMPORTED_MODULE_4_moment___default()(this.settings.endDate, "YYYY-MM-DD");
            this.messagesInPeriod = this.twilioMessages.filter(function (_message) {
                var dateSentTmp = __WEBPACK_IMPORTED_MODULE_4_moment___default()(_message.date_sent).format("YYYY-MM-DD");
                var dateSent = __WEBPACK_IMPORTED_MODULE_4_moment___default()(dateSentTmp, "YYYY-MM-DD");
                if (dateSent.isBetween(startDate_1, endDate_1) && _message.status == 'failed') {
                    _this.failedMessages.push(_message);
                }
                return dateSent.isBetween(startDate_1, endDate_1) && _message.status != 'failed';
            });
