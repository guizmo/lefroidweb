webpackJsonp([0],Array(397).concat([
/* 397 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__players__ = __webpack_require__(531);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_pagination__ = __webpack_require__(533);
...
PlayersPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__players__["a" /* PlayersPage */]),
        ],
    })
], PlayersPageModule);
...
var forkJoin_1 = __webpack_require__(267);
...
var EmptyError_1 = __webpack_require__(520);
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_observable_forkJoin__ = __webpack_require__(517);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_first__ = __webpack_require__(518);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_angular2_csv_Angular2_csv__ = __webpack_require__(532);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_lots_lots__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_game_game__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_players_players__ = __webpack_require__(268);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PlayersPage = (function () {
    function PlayersPage(afdb, navCtrl, navParams, gameService, lotsService, playersService, alertCtrl) {
        this.afdb = afdb;
        ...
        this.pageTitle = 'Joueurs';
        this.borne = this.navParams.get('borne');
        this.fetchData();
    }
    PlayersPage.prototype.ionViewDidLoad = function () {
    };
    PlayersPage.prototype.ionViewDidLeave = function () {
        if (this.playersSub) {
            this.playersSub.unsubscribe();
        }
    };
    PlayersPage.prototype.fetchData = function () {
        var _this = this;
        if (this.borne) {
            this.players = this.playersService.get(this.borne);
            this.pageTitle = 'Joueurs : ' + this.borne.replace('_', ' ');
            this.dataSubscriptions = __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].forkJoin(this.lotsService.get(this.borne).first(), this.gameService.get(this.borne).first());
            this.dataSubscriptions.subscribe(function (res) {
                _this.lotsList = res[0];
                _this.gameParams = res[1];
                _this.playersSub = _this.players.subscribe(function (res) {
                    if (res) {
                        _this.playersList = res.filter(function (_player) {
                            return _player.$key !== '0';
                        }).map(function (_player) {
                            var winning = _player.winning.split('|');
                            var playingDay = __WEBPACK_IMPORTED_MODULE_3_moment___default()(_this.gameParams.starDate).add(winning[0].replace('d_', '') - 1, 'days');
                            _player.playingDay = playingDay.format('DD/MM/YY');
                            _player.lot = winning[1] == 'false' ? '-' : _this.lotsList['lot_' + winning[1]].label_admin;
                            return _player;
                        });
                        _this.playersList.reverse();
                    }
                });
            });
        }
    };
    PlayersPage.prototype.delete = function (player) {
        var _this = this;
        var confirm = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'Oui',
                    handler: function () {
                        _this.playersService.delete(player);
                    }
                }
            ]
        });
    ...
    PlayersPage.prototype.reset = function () {
        var _this = this;
        var confirm = this.alertCtrl.create({
            title: 'Action',
    ...
    PlayersPage.prototype.exportCsv = function () {
        var options = {
            fieldSeparator: ',',
            quoteStrings: '"',
            decimalseparator: '.',
        ...
        var filename = this.pageTitle;
        var data = this.playersList.map(function (_player) {
            if (_player.$key !== '0') {
                delete _player.winning;
                return _player;
            }
        });
        new __WEBPACK_IMPORTED_MODULE_7_angular2_csv_Angular2_csv__["Angular2Csv"](data, filename, options);
    };
    return PlayersPage;
}());
PlayersPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-players',template:/*ion-inline-start:"/Users/guillaumebartolini/apps/lefroidweb/src/pages/players/players.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-buttons start>\n      <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>{{pageTitle}}</ion-title>\n    <ion-buttons end>\n      <button ion-button color="danger" icon-right (click)="reset()">\n        Effacer tous les joueurs\n        <ion-icon name="trash"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-grid class="table-grid">\n    <ion-row  class="table-head">\n      <ion-col class="table-col align-items" col-2 align-self-center>Date</ion-col>\n      <ion-col class="table-col align-items" col-4 align-self-center>Nom</ion-col>\n      <ion-col class="table-col align-items" col-3 align-self-center>Lot</ion-col>\n      <ion-col class="table-col align-items" col-2 align-self-center>Numéro</ion-col>\n      <ion-col class="table-col align-items" col-1 align-self-center>Action</ion-col>\n    </ion-row>\n\n    <ion-row *ngFor="let player of playersList | paginate: { itemsPerPage: 10, currentPage: p }" class="table-tr" >\n      <ion-col class="table-col align-items" col-2><span>{{player.playingDay}} - {{player.time}}</span></ion-col>\n      <ion-col class="table-col align-items" col-4><span>{{player.nom}}</span></ion-col>\n      <ion-col class="table-col align-items" col-3><span>{{player.lot}}</span></ion-col>\n      <ion-col class="table-col align-items" col-2><span>{{player.tel}}</span></ion-col>\n      <ion-col class="table-col align-items" col-1>\n        <button ion-button icon-only clear (click)="delete(player)">\n          <ion-icon color="danger" name="trash"></ion-icon>\n        </button>\n      </ion-col>\n    </ion-row>\n\n  </ion-grid>\n  <ion-grid>\n    <ion-row>\n      <ion-col text-center>\n        <pagination-controls (pageChange)="p = $event"></pagination-controls>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n  <ion-toolbar>\n    <ion-buttons end>\n      <button ion-button color="positive" icon-right (click)="exportCsv()">\n        Exporter tous les joueurs\n        <ion-icon name="download"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n\n</ion-content>\n'/*ion-inline-end:"/Users/guillaumebartolini/apps/lefroidweb/src/pages/players/players.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_angularfire2_database__["a" /* AngularFireDatabase */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_9__providers_game_game__["a" /* GameProvider */],
        __WEBPACK_IMPORTED_MODULE_8__providers_lots_lots__["a" /* LotsProvider */],
        __WEBPACK_IMPORTED_MODULE_10__providers_players_players__["a" /* PlayersProvider */],
...
PaginationControlsComponent.propDecorators = {
    ...
    'pageChange': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["S" /* Output */] },],
};
